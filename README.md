...
To refresh, run `backend/services/preload_walking_times.py` from the repo root. This requires a OneMap account — register at [onemap.gov.sg](https://www.onemap.gov.sg) and set your credentials as environment variables before running:
